...
$route['data-kelas'] = 'Konfigurasi/datakelas';
$route['tambah-kelas'] = 'Konfigurasi/addkelas';
$route['rubah-kelas/?(:num)?'] = 'Konfigurasi/editkelas/$1';
$route['hapus-kelas/?(:num)?'] = 'Konfigurasi/hapuskelas/$1';
